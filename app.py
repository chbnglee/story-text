...
CR-7  REPORTED SPEECH — ALL OR NONE.
      A reporting clause ("X says", "he calls") attached to direct speech
      must receive the SAME treatment across the entire batch.
      V + quoted-object (e.g. says "Bear") is a simple V+O, not a chunk;
      do not insert @@ between a verb and its quoted object.
      Reporting clause after speech may be split with @@  but must be
      applied to ALL such instances — mixing is an error.
