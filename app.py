...
Output: SC01_ST01_N_C = By the way,@@there is@@no way of knowing@@what will@@take place.
  ...
  → "no way of knowing" = FORMULAIC_UTTERANCE (conventionalised+idiomatic+functional)
...
Output: SC02_ST01_D_C = Milo is a little chameleon,@@and he loves to@@change his colors.
  → "loves to" verb-pattern boundary; "change his colors" = COLLOCATION (conventionalised)
...
Output: SC04_ST01_N_C = She@@fell asleep@@on the soft grass.
  → "fell asleep" = COLLOCATION (conventionalised+idiomatic); sentence > 5 words → split applies.

Input:  SC05_ST01_E = He ran away quickly.
Output: SC05_ST01_E_C = He ran away@@quickly.
  → "ran away" = PHRASAL_VERB (conventionalised+idiomatic); not a whole-sentence formulaic.
